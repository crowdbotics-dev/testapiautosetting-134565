...
class Testconnectors134565ViewSet(BaseConnectorViewSet):
    PASSWORD = settings.CONNECTOR_TESTCONNECTORS134565_PASSWORD
    USERNAME = settings.CONNECTOR_TESTCONNECTORS134565_USERNAME
    BASE_URL = "https://devstringx.com"
    AUTH_TYPE = "basic"
    IDENTIFIER = "CONNECTOR_TESTCONNECTORS134565"
